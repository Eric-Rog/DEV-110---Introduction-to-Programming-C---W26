...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        string titlePrimary = "TEXT MENU STUDIO";

        // - subtitle: "Strings + Console Output Patterns"
        string titleSecondary = "Strings + Console Output Patterns";
        ...
        Console.WriteLine(titlePrimary);
        Console.WriteLine(titleSecondary);
        Console.WriteLine(divLine);
        ...
        while (choice != 6)
        {
            ...
            {
                case 1:
                    Console.WriteLine("you picked 1: greeting card");
                    break;
                case 2:
                    Console.WriteLine("you picked 2: choice two pickup a shoe");
                    break;
                case 3:
                    Console.WriteLine("you picked 3: choice 3 I am a tree");
                    break;
                case 4:
                    Console.WriteLine("you picked 4: choice 4, I've lost the will to continue working on this assignment anymore tonight");
                    break;
                case 6:
                    Console.WriteLine("you picked 6: exiting now");
                    break;
